#  Tema Dia🌞 e Noite🌙 Simplificado😊

**Um projeto simple e mais competo de um site que muda o visual conforme clica no botão. Base para futuros projetos.

### Front-End:
- Custom Properties (Variáveis CSS)
- Manipulação de DOM (Vanilla JS)
- UX Circadiana (ou Design Adaptativo)
